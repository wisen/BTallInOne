...
class BluetoothPbapSession implements Callback {
    ...
    public BluetoothPbapSession(BluetoothDevice device, Handler handler) {
        ...
        Log.d(TAG, "BluetoothPbapSession create!");
    ...
    public boolean handleMessage(Message msg) {
        ...
        switch (msg.what) {
            case RFCOMM_FAILED:
                Log.d(TAG,"debug_ang : RFCOMM_FAILED ");
                mConnectThread = null;
    ...
    private class RfcommConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                Log.d(TAG,"debug_ang : before connect(), state is : " + mSocket.isConnected());
                mSocket.connect();
                Log.d(TAG,"debug_ang : after connect(), state is : " + mSocket.isConnected());
                ...
                Log.d(TAG,"debug_ang : mSocket.connect() failed,  state : " + mSocket.isConnected());
                closeSocket();
