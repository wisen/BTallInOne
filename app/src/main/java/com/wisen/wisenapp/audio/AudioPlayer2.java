...
/**
 * Created by wisen on 2016-06-30.
 */
public class AudioPlayer2 implements IPlayComplete {
    ...
    public AudioPlayer2(Handler handler)
    {
        mHandler = handler;
    }

    public AudioPlayer2(Handler handler,AudioParam audioParam)
    {
        mHandler = handler;
        ...
        public void run() {
            ...
            while(true)
            {
                ...
                try {
                    ...
                    e.printStackTrace();
                    AudioPlayer2.this.onPlayComplete();
                    break;
                }
