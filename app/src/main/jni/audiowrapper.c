...
#include <math.h>
#include <string.h>
#include "ilibc_src/iLBC_define.h"
#include "ilibc_src/iLBC_decode.h"
#include "ilibc_src/iLBC_encode.h"
#include "swordbearer_audio_AudioCodec.h"
...
jint Java_swordbearer_audio_AudioCodec_audio_1codec_1init(JNIEnv *env,
                                                              jobject this, jint mode) {
    LOGD("Java_swordbearer_audio_AudioCodec_audio_1codec_1init start");
    initEncode(&g_enc_inst, mode);
    initDecode(&g_dec_inst, mode, 1);
    LOGD("Java_swordbearer_audio_AudioCodec_audio_1codec_1init end");
}
...
jint Java_swordbearer_audio_AudioCodec_audio_1encode(JNIEnv *env,
...
jint Java_swordbearer_audio_AudioCodec_audio_1decode(JNIEnv *env,
                                                         jobject this, jbyteArray dataArray, jint dataOffset, jint dataLength,
                                                         jbyteArray sampleArray, jint sampleOffset) {
    LOGD("Java_swordbearer_audio_AudioCodec_audio_1decode start");
    jsize samples_sz, data_sz;
    jbyte *samples, *data;
    ...
    LOGD("Java_swordbearer_audio_AudioCodec_audio_1decode end");
